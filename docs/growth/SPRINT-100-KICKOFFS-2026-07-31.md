...
| S23 | Directory and launch-platform registrations: Product Hunt, Uneed, Fazier, DevHunt, SaaSHub, AlternativeTo, Indie Hackers, G2, LinkedIn product link, GBP product link | dedicated chat prepares packs + walks through, Constantin submits (accounts and CAPTCHAs are his hands only) | day | **IN PROGRESS 2026-08-04** (chat `S23 · Directory registrations`). All 10 packs written to `docs/growth/launch-directories/`, committed `c48fd5b` (not yet pushed, rides the batch push). **SaaSHub LIVE**: https://www.saashub.com/brandgeo-global-alternatives. Constantin mid-submission on Product Hunt (prelaunch page exists, corrections drafted) and Uneed (Detailed Description pasted). Remaining lane 1 (AlternativeTo, Indie Hackers, G2, LinkedIn, GBP) and lane 2 (PH, Uneed, Fazier, DevHunt) still Constantin's hands to submit. |
