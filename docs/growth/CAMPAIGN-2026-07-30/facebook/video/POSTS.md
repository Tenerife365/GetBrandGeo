# Facebook Reels, ready to paste

Nine cuts, one per run. Nothing here has been posted or scheduled.

## How to use this

**Upload the `-silent.mp4`.** It has no audio stream at all, by design. Pair it
with a track from Facebook's own in-app music library at upload. Audio picked
there is licensed for the platform and is favoured by its distribution, whereas a
self-supplied track that is not cleared gets muted or region blocked.
...
**Paste the body as written.** Facebook renders the link in the post body
directly, so the URL sits on its own line at the end and needs no first-comment
trick. Line breaks are intentional. Every body runs 80 to 150 words, which is
longer and plainer than the TikTok copy for the same cut, because this audience
reads more and tolerates less category vocabulary.

**Each body extends the video rather than restating it.** The video makes the
argument; the caption carries what the video had no room for, which is usually
the mechanism, the source, or the limit on the claim. If you shorten one, cut
from the middle, not the end, because the last line before the link is the only
thing doing CTA work.

**No figure in any of these copy blocks is illustrative.** Where a number
appears it was measured by BrandGEO's own collection pipeline and the page it
was measured on is linked in the same block.

---

## 1. Loss aversion

**Silent master:** `facebook/video/20260729-2200-facebook-silent.mp4`
**Hook driver:** #1, loss aversion
**What it argues:** an AI answered a buying question this morning, named a few
businesses, and if you were not one of them nothing reported it to you.
...
**Silent master:** `facebook/video/20260729-2318-facebook-silent.mp4`
**Hook driver:** #2, status threat
**What it argues:** the answer slot in your category is occupied, and it is held
by the name the engines repeat rather than by the biggest spender.
...
**Silent master:** `facebook/video/20260730-0013-facebook-silent.mp4`
**Hook driver:** #3, curiosity gap
**What it argues:** five engines, six questions, one city, and two categories
that produced opposite results.
...
**Silent master:** `facebook/video/20260730-0113-facebook-silent.mp4`
**Hook driver:** #4, contrarian
**What it argues:** a page one Google ranking and being named in an AI answer are
two separate measurements, and one does not predict the other.
...
**Silent master:** `facebook/video/20260730-0216-facebook-silent.mp4`
**Hook driver:** #5, concrete proof
**What it argues:** here is the exact prompt, the exact engines, and exactly
where one company landed in each answer.
...
**Silent master:** `facebook/video/20260730-0313-facebook-silent.mp4`
**Hook driver:** #6, utility
**What it argues:** three steps you can run yourself today, for free, and the one
thing that check cannot do.
...
**Silent master:** `facebook/video/20260730-0413-facebook-silent.mp4`
**Hook driver:** #1, loss aversion, replication with a different execution
**What it argues:** an AI answer is a shortlist drawn before anyone contacts you,
and your reporting reads the same whether you were on it or not.
...
**Silent master:** `facebook/video/20260730-0513-facebook-silent.mp4`
**Hook driver:** #2, status threat, replication with a different execution
**What it argues:** you can be named by an AI and still be described wrong, and
that description is what reaches the buyer.
...
**Silent master:** `facebook/video/20260730-0613-facebook-silent.mp4`
**Hook driver:** #3, curiosity gap, replication with a different execution
**What it argues:** the same question asked in two languages produced answers
that pointed in opposite directions, engine by engine.
...
the same list reordered by language. A different set of companies. One firm that
showed up repeatedly in the French answers was missing from the English ones
altogether.
