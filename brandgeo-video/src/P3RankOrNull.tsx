...
export const P3RankOrNull: React.FC<P3RankOrNullProps> = ({
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: T.bg, fontFamily: FONT }}>
      ...
      >
        {/* Spacing tightened 2026-07-31. Raising the top inset from 100 to 200,
          * which the package's declared box requires, pushed this stack past the
          * bottom of its own padding box. Once the children are taller than the
          * container, `marginTop: auto` on the last block stops doing anything
          * and the ink spilled to y=1620 against a ceiling of 1559.
          *
          * THE BRACES AROUND THIS COMMENT ARE LOAD BEARING. Written as a bare
          * block comment it sat inside JSX as a TEXT NODE and rendered on the
          * card, in the frame, as eight lines of grey source code. Nothing
          * errored, tsc was clean, and the render exited 0. What caught it was
          * tools/check_render.py: the top of the ink jumped 120px and the region
          * declared for the source line came back with 0 pixels. */}
