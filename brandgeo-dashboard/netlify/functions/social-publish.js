...
//
// Rank and both caps come from _plans.js, never from a local table. This file
// used to hand-write `PLAN_RANK = { free: 0, essentials: 1, ... }`, which was a
// second, worse copy of planRank(): when `radar` was inserted at position 1 on
// 2026-07-31 every rank in that literal was off by one against the real ladder,
// and radar itself resolved to 0. It denied AI Social correctly by accident, not
// by intent, and the accident does not survive the next insertion.
